...
\begin{figure}[htbp]
    ...
    \fcaption{Illustration of recognition successes (the first row) and failures (the second row). The most top predicting scores are on the right side of each sketch.}
    \label{fig:resshow}
\end{figure}
