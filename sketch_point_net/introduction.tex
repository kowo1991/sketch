...
\para{Point-based DNNs.} Compared with ConvNet, a brand-new concept, which directly takes the discrete points as input, is presented for the point cloud processing~\cite{qi2017pointnet, qi2017pointnetplusplus, 1801.07791}.
